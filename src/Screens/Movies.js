...
const MoviesPage = () => {
  ...
  return (
    <Layout>
    <div className='min-height-screen container mx-auto px-4 my-6'>
     <Filters/>
     <p className='text-lg font-medium my-6'>Total <span className='font-bold text-subMain'>
       {Movies.length}</span>{' '} items Found
       </p>
