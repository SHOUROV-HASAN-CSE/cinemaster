      ...
      <div className='bg-main shadow-md sticky top-0 z-20'>
        <div className="container mx-auto py-6 px-10 lg:grid gap-10 grid-cols-7 justify-between items-center">
          ...
          <div className='col-span-1 lg:block hidden'>
            <Link to="/">
              <img className='w-full h-12 object-contain' src='/images/logo.png'  alt="" />
            </Link>
          </div>
          {/* search from */}
          <div className='col-span-3'>
            <form action="" className='w-full text-sm bg-dryGray rounded flex-btn gap-4'>
              <button type='submit' className='bg-subMain w-12 flex-colo h-12 rounded text-white '> <FaSearch/>
              </button>
